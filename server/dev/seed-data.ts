...
// テーマタグ12種: 発明 心理 子育て 剣道 夫婦 会社 AI マーケティング 転職 親との関係 節約 地方創生
...
export const seedIntermediateRecords = [
  ...
  },
  {
    ...
    themeTags: JSON.stringify(['地方創生', '夫婦']),
  ...
  },
  {
    ...
    themeTags: JSON.stringify(['親との関係', '心理']),
  ...
  },
  {
    ...
    themeTags: JSON.stringify(['子育て', '心理']),
  ...
  },
  {
    ...
    themeTags: JSON.stringify(['マーケティング', '節約']),
  ...
  },
  {
    ...
    themeTags: JSON.stringify(['子育て', '夫婦']),
  ...
  },
  {
    ...
    themeTags: JSON.stringify(['夫婦', '子育て']),
  ...
  },
  {
    ...
    themeTags: JSON.stringify(['節約', 'AI']),
  ...
  },
  {
    ...
    themeTags: JSON.stringify(['転職', '節約']),
  ...
  // ---- 2026 Apr-Jun (既存 ir-001〜012 を維持、追加分) ----
  {
...
export const seedMemorySnapshots = [
  ...
  },
  {
    ...
    tagSummaries: ts([
      ['会社',     1, 0, '新年度のスタートで気持ちを切り替え、残りの在職期間を前向きに過ごす決意をした', '', '新年度切替'],
      ['AI',       1, 0, 'Cloudflare D1への移行作業が完了し、本番環境に近い構成で開発できるようになった', '', 'D1移行完了'],
      ['節約',     1, 0, '独立への貯蓄目標に向けて、サブスク整理で月3,000円の固定費削減', '', '固定費削減'],
    ]),
  ...
  },
  {
    ...
    tagSummaries: ts([
      ...
      ['発明',     0, 1, '', '技術的な壁にぶつかるたびに「自分には無理かも」という不安が一瞬よぎる', '限界感あり'],
  ...
  },
  {
    ...
    tagSummaries: ts([
      ...
      ['発明',     1, 0, 'バグを直したときの達成感は格別。先週の停滞があったからこそ喜びが大きい', '', 'バグ解消↑'],
      ['会社',     0, 1, '', '上司から「副業の時間を本業に使え」と遠回しに言われ、モチベーションが下がった', '副業横やり'],
    ]),
  ...
  },
  {
    ...
    tagSummaries: ts([
      ['マーケティング', 1, 0, '副業で新規クライアントからの問い合わせが来た。紹介での獲得で、信頼の連鎖を感じた', '', '新規問合せ'],
      ['夫婦',     1, 0, '週末に家族で公園に行き、子どもの成長を感じた。ゆったりとした時間が取れた', '', '公園で充電'],
      ['子育て',   1, 0, '子どもが初めて「パパ」と言った。仕事も副業も全部報われた気がした', '', '初「パパ」↑'],
    ]),
  ...
  },
  {
    ...
    tagSummaries: ts([
      ['発明',     1, 0, 'GW前半に集中してアーキテクチャの見直しをした。コンポーネント設計が整理された', '', '設計整理'],
  ...
  },
  {
    ...
    tagSummaries: ts([
      ...
      ['発明',     2, 0, 'プロトタイプを自分で使ってみたら、過去の自分を客観視できて面白かった', '', '客観視↑'],
  ...
  },
  {
    ...
    tagSummaries: ts([
      ['会社',     0, 2, '', 'GW明けの仕事がつらく感じた。同僚との温度差が気になった', 'GW明け辛'],
  ...
  },
  {
    ...
    tagSummaries: ts([
      ...
      ['会社',     0, 1, '', 'プロジェクトの方向転換で余計な仕事が増えた', '仕事増加'],
  ...
  },
  {
    ...
    tagSummaries: ts([
      ['マーケティング', 2, 0, '副業の月収が過去最高を更新。3社継続・1社新規で月15万円に到達した', '', '月15万達成'],
      ['節約',     1, 0, '収入増に合わせて、独立に向けた投資（開発サーバー代・書籍）も計画的に行えた', '', '計画投資'],
      ['夫婦',     1, 0, 'パートナーと副業の進捗を共有し、来年の独立スケジュールについて話し合えた', '', '独立計画共有'],
  ...
  },
  {
    ...
    tagSummaries: ts([
      ['発明',     1, 0, 'タイムライン可視化UIの設計を開始。どう見せるかを考えるのが楽しかった', '', 'TL設計開始'],
      ['AI',       1, 0, 'タグサマリーの生成ロジックが完成。データの流れが全部つながった', '', '生成完成'],
      ['会社',     0, 1, '', '評価制度の不透明さに改めて不満を感じた。独立への動機づけになっている', '制度不満'],
    ]),
  ...
  },
  {
    ...
    tagSummaries: ts([
      ...
      ['発明',     1, 0, '自分のアイデアがプロダクトとして動いている充実感が大きい', '', '充実感大'],
      ['会社',     0, 1, '', '評価が不透明で疲弊。転職を本格的に検討し始めている', '評価疲弊'],
  ...
  // ────────────────────────────────────
  {
    ...
    tagSummaries: ts([
      ['マーケティング', 2, 0, '副業月収が初めて5万円を超えた。2社の継続契約で安定感が出てきた', '', '月5万超え'],
      ['AI',       1, 0, '業務効率化の提案でAIを積極的に使い、評価が上がった', '', '業務評価↑'],
      ['会社',     0, 1, '', '夏の長時間労働と副業の疲れが重なり、体力的にきつかった', '夏疲労'],
      ['節約',     1, 0, '副業収入を全額貯蓄に回せた。年末の独立資金計画が現実味を帯びてきた', '', '全額貯蓄'],
    ]),
  ...
  },
  {
    ...
    tagSummaries: ts([
      ['マーケティング', 2, 0, '副業2件目のプロジェクトが軌道に乗り始めた。クライアントからの信頼を得られた', '', '2件軌道'],
      ['地方創生',  1, 0, '長野旅行で移住への具体的なイメージが湧いた。パートナーも前向きになった', '', '長野移住↑'],
      ['AI',       1, 0, 'Webアプリを個人で初めて公開した。技術的な自信がついた', '', '初公開↑'],
      ['節約',     1, 0, '固定費の見直しで月2万円の削減に成功', '', '月2万削減'],
    ]),
  ...
  },
  {
    ...
    tagSummaries: ts([
      ...
      ['親との関係', 0, 1, '', '親が体調を崩したと連絡。帰省で仕事・副業とも止まった週があった', '親体調不良'],
  ...
  },
  {
    ...
    tagSummaries: ts([
      ...
      ['会社',     0, 2, '', '年末評価で昇格見送り。組織への帰属意識が完全に薄れた', '昇格見送り'],
      ['AI',       2, 0, 'セミナー登壇をきっかけにフォロワーが増え、副業案件の問い合わせが来るようになった', '', 'フォロワー増'],
      ['マーケティング', 1, 0, '副業収入が月8万円に到達。本業の手取りの40%に相当する規模になった', '', '月8万達成'],
    ]),
  ...
  },
  {
    ...
    tagSummaries: ts([
      ...
      ['発明',     2, 0, '年末年始の連休を使って最初のプロトタイプを作り始めた。技術的には見通しが立った', '', '原型開始'],
      ['夫婦',     1, 0, '来年の独立に向けてパートナーと具体的な財務計画を立てた。二人で同じ方向を向けている', '', '独立計画↑'],
  ...
  },
  {
    ...
    tagSummaries: ts([
      ...
      ['発明',     2, 0, '年始から「1日1機能」のペースで実装が進んでいる。やっていることが楽しい', '', '1日1機能'],
      ['子育て',   1, 0, '育児が落ち着いてきた。子どもと過ごす時間を大切にしながら開発する習慣ができた', '', '育児×開発'],
      ['節約',     1, 0, '副業と貯蓄の計画が順調。独立タイムラインが見えてきた', '', '独立見通し'],
    ]),
  ...
  },
  {
    ...
    tagSummaries: ts([
      ['子育て',   1, 1, '子どもの成長に喜ぶ一方、夜泣きで睡眠不足が続いた月', 'パートナーとの喧嘩も増えた時期。互いの疲れが蓄積していた', '成長と夜泣'],
      ['AI',       2, 0, '睡眠不足でも開発が楽しくて続けられた。プロトタイプが初めて自分で使えるレベルに', '', '不足でも前進'],
      ['夫婦',     1, 0, 'バレンタインを機に家事分担を見直し、関係が改善した', '', '分担改善'],
      ['発明',     1, 0, 'MY AGENTの初期バージョンが動いた。感動した', '', '初版完成'],
    ]),
  ...
  },
  {
    ...
    tagSummaries: ts([
      ...
      ['発明',     2, 0, '開発ペースが上がった。覚悟が決まると行動が変わると実感', '', '開発加速'],
      ['AI',       2, 0, '副業月収が初めて10万円を突破。独立の現実味が増した', '', '月10万超'],
      ['心理',     1, 0, '迷いがなくなった月。不思議なほど精神的に安定していた', '', '迷い消えた'],
      ['地方創生',  1, 0, '長野の移住候補地を下見。リアルなイメージができてきた', '', '下見実施'],
    ]),
  ...
  },
  {
    ...
    tagSummaries: ts([
      ...
      ['発明',     2, 0, '技術的な壁を越えた週あり、達成感が大きかった', '', '技術壁越え'],
      ['会社',     0, 2, '', '新プロジェクトで上司との価値観の差を感じ、消耗した', '価値観ズレ'],
      ['マーケティング', 1, 0, 'AI×マーケティングの強みを社内外で発揮できている', '', '社内外活躍'],
    ]),
  ...
  },
  {
    ...
    tagSummaries: ts([
      ...
      ['発明',     3, 0, 'プロダクトを自分で使うループが回り始めた。自分のデータで検証できる充実感', '', '自己検証↑'],
      ['マーケティング', 2, 0, '副業月収が過去最高の15万円に到達。3社継続・1社新規', '', '月15万最高'],
      ['会社',     0, 2, '', 'GW明けの反動で本業がつらかった。評価制度への不満も増大', '本業辛い'],
  ...
  },
  {
    ...
    tagSummaries: ts([
      ...
      ['発明',     2, 0, '自分で作ったツールで自分を振り返る体験が面白い。プロダクトの価値を確信', '', '価値確信'],
      ['会社',     0, 2, '', '評価が不透明で疲弊。独立への動機が高まっている', '評価疲弊'],
      ['転職',     0, 1, '', '転職ではなく独立。この気持ちは揺るがない', '独立一択'],
      ['夫婦',     1, 0, 'パートナーと独立後の生活をより具体的に話せるようになった', '', '独立話進む'],
    ]),
  ...
  // ────────────────────────────────────
  {
    ...
    tagSummaries: ts([
      ...
      ['会社',     2, 1, '入社5年目で業務に自信が持てるようになり、後輩指導も任された', '組織の理不尽さを感じることも増えてきた', '自信ついた'],
      ['心理',     1, 1, '社会人としての自分が形成されてきた年。自分は何をしたいのかを考え始めた', '将来への漠然とした不安もあった', '将来を模索'],
      ['親との関係', 1, 0, '実家の両親と久しぶりにゆっくり話せた帰省があった。感謝を伝えられた', '', '感謝伝えた'],
    ]),
  ...
  },
  {
    ...
    tagSummaries: ts([
      ['会社',     4, 0, 'マーケティング部門への異動が転機。仕事が面白くなり、初めてやりがいを感じた一年', '', 'やりがい発見'],
      ['マーケティング', 4, 0, 'SNSマーケティングとコンテンツ戦略を担当し、成果が数字で見えた。自分の強みを発見できた年', '', '強み発見'],
      ['夫婦',     3, 1, '結婚した。二人の生活が始まり、幸福度が上がった年', '生活習慣や金銭感覚の違いで衝突することもあった', '結婚↑'],
      ['剣道',     2, 0, '段位取得（三段）。稽古の質が上がってきた', '', '三段取得'],
      ['節約',     1, 0, '結婚を機に家計管理を始めた。投資信託の積み立てをスタート', '', '投資開始'],
    ]),
  ...
  },
  {
    ...
    tagSummaries: ts([
      ...
      ['マーケティング', 3, 0, 'AI×マーケティングの組み合わせが強力だと気づき、社内でも一目置かれるようになった', '', 'AI×MKT強み'],
      ['発明',     2, 0, 'AIを使って簡単なツールを作り始めた。プログラミングへの興味が再燃した', '', 'ツール作開始'],
      ['会社',     1, 2, '', '評価は上がったが、会社の方向性と自分のやりたいことのずれを感じ始めた', '方向性ズレ'],
  ...
  },
  {
    ...
    tagSummaries: ts([
      ['子育て',   2, 2, '子どもが生まれた。人生最大の喜びと、想像以上の大変さが同時にやってきた年', '睡眠不足と仕事・副業との両立で体力的に限界を感じた', '出産↑大変'],
      ['AI',       4, 0, 'Claude API等を本格的に学習。副業に向けた技術力が急速に上がった年', '', '技術力急伸'],
      ['転職',     1, 1, '転職エージェントに登録し、情報収集した', '「転職か独立か」の間で揺れ続けた年', '独立か迷い'],
      ['節約',     2, 0, '育児費用の増加に備えた節約と、副業への先行投資を両立させた', '', '先行投資↑'],
      ['夫婦',     2, 1, '育児を通じてパートナーとの絆が深まった', '余裕がないときの摩擦も多かった', '絆深まる'],
      ['会社',     0, 3, '', '育休明けの職場の雰囲気に違和感。副業・個人開発に力を入れるほど、本業への熱量が落ちていった', '熱量低下'],
    ]),
  ...
  },
  {
    ...
    tagSummaries: ts([
      ...
      ['マーケティング', 4, 0, 'AI×マーケの専門家として副業で認知され、紹介案件が絶えない状態に', '', '副業認知↑'],
      ['転職',     2, 2, '転職活動を試みたが年末に断念し、独立路線へ完全シフト', '2社の面接落ちがあり、自信が揺らいだ時期も', '独立へ転換'],
      ['地方創生',  2, 0, '長野を中心に移住候補地の下見を行い、現実的な計画が立てられた', '', '移住計画↑'],
      ['発明',     3, 0, 'MY AGENTの構想が生まれ、プロトタイプ開発を開始。作ることへの喜びが復活した', '', 'MYAGENT着想'],
      ['会社',     0, 4, '', '年末評価での昇格見送りで会社への帰属意識がほぼ消えた。独立の最終的な動機付けになった', '帰属感消滅'],
      ['節約',     2, 0, '副業収入を計画的に蓄え、独立資金の目標額の50%に到達', '', '資金50%達'],
    ]),
  ...
  // ────────────────────────────────────
  {
    ...
    tagSummaries: ts([
      ...
      ['発明',     2, 0, 'プロダクトを0→1で作る経験を通じて、開発の自信と楽しさを取り戻した', '', '0→1経験'],
      ['会社',     0, 2, '', '評価・方向性への不満が継続。これが転職・独立を考える主なドライバーになっている', '不満継続'],
      ['剣道',     0, 1, '', '仕事・副業が優先になり稽古時間が確保できていない。優先度の再考が必要', '稽古不足'],
      ['マーケティング', 2, 0, 'AIとマーケティングの掛け算という自分の強みを社内外で発揮できている', '', '強み発揮'],
      ['夫婦',     1, 0, 'パートナーと将来のライフプランを話せるようになってきた。副業が会話を生んでいる', '', '計画共有'],
    ]),
